...
COMPLEX_INPUT_FILES = [
    [
        ...
        " must always be associated in my mind with my wooing, and with the dark incidents" +
        " of the Study in Scarlet, I was seized with a keen desire to see Holmes again," +
        " and to know how he was employing his extraordinary powers. His rooms were" +
...
def test_create_story(input_file, result):
    """Test create_story function with simple files
    to create a specific new story using trigrams."""
    import trigrams
...
def test_create_story_complex(input_file, result):
    """Test create_story function with complex files
    to create a new story of the same style using trigrams."""
